...
Dataform allows teams to create and update tables and views in their data warehouse. To be able to do this, you’ll need to connect to your warehouse. In order to do this, Dataform requires some warehouse access details.

To set up your warehouse connection, open the Database settings tab.

<img
  src="/static/images/platform_guides/datawarehouse/db_settings_page.png"
  style={{ width: "100%" }}
/>
